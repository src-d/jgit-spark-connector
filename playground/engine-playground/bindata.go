...
func dockerComposeYmlTmplBytes() ([]byte, error) {
	return _dockerComposeYmlTmpl, nil
}

func dockerComposeYmlTmpl() (*asset, error) {
	bytes, err := dockerComposeYmlTmplBytes()
	if err != nil {
		return nil, err
	}
...
var _bindata = map[string]func() (*asset, error){
	"docker-compose.yml.tmpl": dockerComposeYmlTmpl,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"docker-compose.yml.tmpl": &bintree{dockerComposeYmlTmpl, map[string]*bintree{}},
}}
